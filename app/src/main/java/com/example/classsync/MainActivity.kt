...
import androidx.compose.material.icons.filled.CheckCircle // Icon for current schedule
import androidx.compose.material.icons.filled.Edit // Icon for entering selection mode (Replaced Checklist)
import androidx.compose.material.icons.filled.Close // Icon for exiting selection mode or closing dialogs
import androidx.compose.material.icons.filled.Delete // Icon for deleting items
import androidx.compose.material.icons.filled.KeyboardArrowRight
import androidx.compose.material.icons.outlined.RadioButtonUnchecked // Icon for unselected state
